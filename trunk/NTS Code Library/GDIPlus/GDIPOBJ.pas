...
\**************************************************************************)
  ...
  public
    ...
    function GP_Equals(region: TGPRegion; g: TGPGraphics): BOOL;
...
\**************************************************************************)
  ...
  public
    ...
    function GP_Equals(matrix: TGPMatrix): BOOL;
    function GetLastStatus: TStatus;
  end;
...
\**************************************************************************)
  ...
  function TGPMatrix.GP_Equals(matrix: TGPMatrix): BOOL;
  begin
    result := FALSE;
...
\**************************************************************************)
  ...
  function TGPRegion.GP_Equals(region: TGPRegion; g: TGPGraphics): BOOL;
  var
    booln: BOOL;
  begin
    booln := FALSE;
