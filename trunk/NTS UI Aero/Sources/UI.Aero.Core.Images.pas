...
begin
 ...
 AlphaBlend(Surface,PartPos.X,PartPos.Y,PartSize.cx,PartSize.cy,Part,PartX,PartY,PartSize.cx,PartSize.cy,Blend);
end;

Class Procedure AeroPicture.StretchDraw(DC: hDC; Image: TBitMap; Pos: TPoint; Size: TSize);
begin
 AlphaBlend(DC,Pos.X,Pos.Y,Size.cx,Size.cy,Image.Canvas.Handle,0,0,Image.Width,Image.Height,Blend);
end;
